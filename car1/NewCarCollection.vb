...
Namespace car1
    ...
    Partial Public Class NewCarCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of car1.NewCar), System.Collections.Generic.ICollection(Of car1.NewCar), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of car1.NewCar) = New System.Collections.Generic.List(Of car1.NewCar)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of Integer, car1.NewCar) = New System.Collections.Generic.Dictionary(Of Integer, car1.NewCar)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm147090233 As CodeFluent.Runtime.Utilities.BindingListManager(Of car1.NewCar)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm147090233 = New CodeFluent.Runtime.Utilities.BindingListManager(Of car1.NewCar)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of car1.NewCar)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of Integer, car1.NewCar)
            Get
        ...
        Public Default Property Item(ByVal index As Integer) As car1.NewCar Implements System.Collections.Generic.IList(Of car1.NewCar).Item
            Get
                Return CType(Me.BaseList(index),car1.NewCar)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,car1.NewCar)
            End Set
        End Property
        
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of car1.NewCar).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of car1.NewCar).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm147090233.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm147090233.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As car1.NewCar, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal newCar As car1.NewCar) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(newCar)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal newCar As car1.NewCar) As Integer
            If (newCar Is Nothing) Then
                Throw New System.ArgumentNullException("newCar")
            End If
            If (newCar.id = -1) Then
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "id", "newCar", "car1.NewCar")
            End If
            Try 
                Me.BaseTable.Add(newCar.id, newCar)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(car1.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "car1.NewCarCollection", newCar.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(car1.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "car1.NewCarCollection", newCar.id), ae)
            End Try
            AddHandler newCar.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(newCar)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, newCar, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (newCar Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(newCar)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_car1_NewCar__Add(ByVal newCar As car1.NewCar) Implements System.Collections.Generic.ICollection(Of car1.NewCar).Add
            Me.BaseAdd(newCar)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As car1.NewCar
            Dim newCar As car1.NewCar = car1.NewCar.LoadByEntityKey(key)
            If ((Not (newCar) Is Nothing)  _
                        AndAlso (Me.Contains(newCar) = false)) Then
                Me.Add(newCar)
            End If
            Return newCar
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of car1.NewCar))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As car1.NewCar, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of car1.NewCar).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As car1.NewCar, ByVal index As Integer)
        ...
        Public Function Contains(ByVal newCar As car1.NewCar) As Boolean Implements System.Collections.Generic.ICollection(Of car1.NewCar).Contains
            Dim localContains As Boolean = Me.BaseContains(newCar)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal newCar As car1.NewCar) As Boolean
            If (newCar Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(newCar.id)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                newCar = Nothing
            End Try
            Return Me.Contains(newCar)
        End Function
        
        Public Function IndexOf(ByVal newCar As car1.NewCar) As Integer Implements System.Collections.Generic.IList(Of car1.NewCar).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(newCar)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal newCar As car1.NewCar) As Integer
            If (newCar Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(newCar)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                newCar = Nothing
            End Try
            Return Me.IndexOf(newCar)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal newCar As car1.NewCar) Implements System.Collections.Generic.IList(Of car1.NewCar).Insert
            Me.BaseInsert(index, newCar)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal newCar As car1.NewCar)
            If (newCar Is Nothing) Then
                Throw New System.ArgumentNullException("newCar")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(car1.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "car1.NewCarCollection", newCar.id), ae)
            End Try
            Me.BaseList.Insert(index, newCar)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, newCar, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                newCar = Nothing
            End Try
            Me.Insert(index, newCar)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of car1.NewCar).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim NewCar As car1.NewCar = Me(0)
                Me.BaseRemove(NewCar)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal newCar As car1.NewCar) As Boolean Implements System.Collections.Generic.ICollection(Of car1.NewCar).Remove
            Return Me.BaseRemove(newCar)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal newCar As car1.NewCar) As Boolean
            If (newCar Is Nothing) Then
                Throw New System.ArgumentNullException("newCar")
            End If
            Dim index As Integer = Me.IndexOf(newCar)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of car1.NewCar).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(newCar)
            RemoveHandler newCar.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(newCar.id)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, newCar, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of car1.NewCar).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of car1.NewCar).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim newCar As car1.NewCar = Me.BaseList(index)
            If (Not (newCar) Is Nothing) Then
                RemoveHandler newCar.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(newCar.id)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of car1.NewCar) Implements System.Collections.Generic.IEnumerable(Of car1.NewCar).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of car1.NewCar) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As Integer) As car1.NewCar
            Dim newCar As car1.NewCar = Nothing
            If (Me.BaseTable.TryGetValue(key, newCar) = true) Then
                Return newCar
            End If
            Return Nothing
        End Function
        
        Public Sub SetItem(ByVal id As Integer, ByVal value As car1.NewCar)
            If (id = -1) Then
                Throw New System.ArgumentNullException("id")
            End If
            If (value Is Nothing) Then
                Dim newCar As car1.NewCar = Me.TryGetValue(id)
                If (Not (newCar) Is Nothing) Then
                    Me.Remove(newCar)
                End If
                Return
        ...
        Public Function GetItem(ByVal id As Integer) As car1.NewCar
            If (id = -1) Then
                Throw New System.ArgumentNullException("id")
            End If
            Dim i As car1.NewCar = Me.TryGetValue(id)
            Return i
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim newCar As car1.NewCar = Me(index)
                newCar.Save
                If (newCar.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(newCar)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(newCar,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(newCar) = false) Then
                        Me.BaseAdd(newCar)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As car1.NewCarCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
            ...
            Try 
                reader = car1.NewCarCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As car1.NewCarCollection
            Dim ret As car1.NewCarCollection = car1.NewCarCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "NewCar", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = car1.NewCarCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As car1.NewCarCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(car1.NewCar)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of car1.NewCar) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,car1.NewCar))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As car1.NewCarCollection
            Dim ret As car1.NewCarCollection = New car1.NewCarCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm147090233.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm147090233.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm147090233.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of car1.NewCar))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of Integer))
            If (e Is Nothing) Then
                Throw New System.ArgumentNullException("e")
            End If
            Dim existing As car1.NewCar = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(car1.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "car1.NewCarCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(car1.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "car1.NewCarCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As car1.NewCarCollection
            Return car1.NewCarCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        ...
        Public Shared Function Save(ByVal newCar As car1.NewCar) As Boolean
            If (newCar Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal newCar As car1.NewCar) As Boolean
            Dim ret As Boolean = car1.NewCar.Save(newCar)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal newCar As car1.NewCar) As Boolean
            If (newCar Is Nothing) Then
                Return false
            End If
