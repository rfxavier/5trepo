...
Namespace car1
    ...
    Partial Public Class State
        Implements System.ICloneable, System.IComparable, System.IComparable(Of car1.State), CodeFluent.Runtime.ICodeFluentCollectionEntity(Of String), System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable(Of car1.State)
        ...
        Private _cities As car1.CityCollection
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property Cities() As car1.CityCollection
            Get
                If (Me._cities Is Nothing) Then
                    If ((Me.Id = -1)  _
                                OrElse (Me.EntityState.Equals(CodeFluent.Runtime.CodeFluentEntityState.Created) = true)) Then
                        Me._cities = New car1.CityCollection(Me)
                        Return Me._cities
                    End If
                    Me._cities = car1.CityCollection.LoadByState(Me)
                End If
                Return Me._cities
            End Get
        End Property
        ...
        Public Overloads Overridable Function Equals(ByVal state As car1.State) As Boolean Implements System.IEquatable(Of car1.State).Equals
            If (state Is Nothing) Then
                Return false
            End If
            If (Me.Id = -1) Then
                Return MyBase.Equals(state)
            End If
            Return (Me.Id.Equals(state.Id) = true)
        End Function
        ...
        Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
            ...
            Try 
                state = CType(obj,car1.State)
            Catch icex As System.InvalidCastException
                state = Nothing
            End Try
            Return Me.Equals(state)
        End Function
        ...
        Overridable Function System_IComparable_CompareTo(ByVal value As Object) As Integer Implements System.IComparable.CompareTo
            ...
            End If
            Dim localCompareTo As Integer = Me.CompareTo(state)
            Return localCompareTo
        End Function
        
        Public Overridable Function CompareTo(ByVal state As car1.State) As Integer Implements System.IComparable(Of car1.State).CompareTo
            If (state Is Nothing) Then
                Throw New System.ArgumentNullException("state")
            End If
            Dim localCompareTo As Integer = Me.Name.CompareTo(state.Name)
            Return localCompareTo
        End Function
        ...
        Public Overloads Overridable Sub Validate(ByVal culture As System.Globalization.CultureInfo, ByVal results As System.Collections.Generic.IList(Of CodeFluent.Runtime.CodeFluentValidationException)) Implements CodeFluent.Runtime.ICodeFluentSummaryValidator.Validate
            ...
            If (evt.Cancel = true) Then
                ...
                Else
                    externalValidate = car1.Resources.Manager.GetStringWithDefault(culture, "car1.State.ExternalValidate", "Type 'car1.State' cannot be validated.", Nothing)
                End If
                CodeFluentPersistence.AddValidationError(results, externalValidate)
            End If
            CodeFluentPersistence.ValidateMember(culture, results, Me, Nothing)
            If (Me.Name Is CType(Nothing, String)) Then
                Dim localValidate As String = car1.Resources.Manager.GetStringWithDefault(culture, "car1.State.Name.NullException", "'Name' property cannot be set to '' for type 'car1.State'", Nothing)
        ...
        Public Overloads Overridable Function Delete() As Boolean Implements CodeFluent.Runtime.ICodeFluentEntity.Delete
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "State", "Delete")
            persistence.AddParameter("@State_Id", Me.Id, CType(-1,Integer))
        ...
        Protected Overridable Sub ReadRecord(ByVal reader As System.Data.IDataReader, ByVal options As CodeFluent.Runtime.CodeFluentReloadOptions)
            ...
            If (((options And CodeFluent.Runtime.CodeFluentReloadOptions.Properties)  _
                        = 0)  _
                        = false) Then
                Me._id = CodeFluentPersistence.GetReaderValue(reader, "State_Id", CType(-1,Integer))
                Me._name = CodeFluentPersistence.GetReaderValue(reader, "State_Name", CType(CType(Nothing, String),String))
            End If
        ...
        Public Shared Function Load(ByVal id As Integer) As car1.State
            If (id = -1) Then
                Return Nothing
            End If
            Dim state As car1.State = New car1.State()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(car1.Constants.car1StoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "State", "Load")
            persistence.AddParameter("@Id", id, CType(-1,Integer))
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = persistence.ExecuteReader
                If (reader.Read = true) Then
                    state.ReadRecord(reader, CodeFluent.Runtime.CodeFluentReloadOptions.[Default])
        ...
        Public Shared Function LoadByName(ByVal name As String) As car1.State
            If (name Is CType(Nothing, String)) Then
                Return Nothing
            End If
            Dim state As car1.State = New car1.State()
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(car1.Constants.car1StoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "State", "LoadByName")
        ...
        Protected Overridable Function BaseSave(ByVal force As Boolean) As Boolean
            ...
            End If
            Dim persistence As CodeFluent.Runtime.CodeFluentPersistence = CodeFluentContext.Get(car1.Constants.car1StoreName).Persistence
            persistence.CreateStoredProcedureCommand(Nothing, "State", "Save")
            persistence.AddParameter("@State_Id", Me.Id, CType(-1,Integer))
            persistence.AddParameter("@State_Name", Me.Name, CType(Nothing, String))
        ...
        Public Overloads Shared Function Save(ByVal state As car1.State) As Boolean
            If (state Is Nothing) Then
                Return false
            End If
        ...
        Public Shared Function Insert(ByVal state As car1.State) As Boolean
            Dim ret As Boolean = car1.State.Save(state)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Shared Function Delete(ByVal state As car1.State) As Boolean
            If (state Is Nothing) Then
                Return false
            End If
        ...
        Protected Overridable Sub BaseTrace(ByVal writer As System.CodeDom.Compiler.IndentedTextWriter)
            ...
            writer.Write(",")
            writer.Write("Cities=")
            If (Not (Me._cities) Is Nothing) Then
                CType(Me._cities,CodeFluent.Runtime.ICodeFluentObject).Trace(writer)
            Else
                writer.Write("<null>")
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Shared Function LoadByEntityKey(ByVal key As String) As car1.State
        ...
        Public Overloads Function Clone(ByVal deep As Boolean) As car1.State
            Dim state As car1.State = New car1.State()
            Me.CopyTo(state, deep)
            Return state
        End Function
        
        Public Overloads Function Clone() As car1.State
            Dim localClone As car1.State = Me.Clone(true)
            Return localClone
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal state As car1.State, ByVal deep As Boolean)
            If (state Is Nothing) Then
                Throw New System.ArgumentNullException("state")
            End If
            state.Id = Me.Id
            state.Name = Me.Name
            Me.OnEntityAction(New CodeFluent.Runtime.CodeFluentEntityActionEventArgs(Me, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, state))
        End Sub
