...
Namespace car1
    ...
    Partial Public Class CarGroupCollection
        Implements System.Collections.IList, System.Collections.ICollection, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList(Of car1.CarGroup), System.Collections.Generic.ICollection(Of car1.CarGroup), System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
        ...
        Private _baseList As System.Collections.Generic.List(Of car1.CarGroup) = New System.Collections.Generic.List(Of car1.CarGroup)()
        
        <System.NonSerializedAttribute()>  _
        Private _baseTable As System.Collections.Generic.Dictionary(Of String, car1.CarGroup) = New System.Collections.Generic.Dictionary(Of String, car1.CarGroup)()
        ...
        <System.NonSerializedAttribute()>  _
        Private _blm4043237448 As CodeFluent.Runtime.Utilities.BindingListManager(Of car1.CarGroup)
...
Private Event System_Collections_Specialized_INotifyCollectionChanged_CollectionChanged As System.Collections.Specialized.NotifyCollectionChangedEventHandler Implements System.Collections.Specialized.INotifyCollectionChanged.CollectionChanged
        ...
        Public Sub New()
            MyBase.New
            Me._blm4043237448 = New CodeFluent.Runtime.Utilities.BindingListManager(Of car1.CarGroup)(Me)
        End Sub
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseList() As System.Collections.Generic.List(Of car1.CarGroup)
            Get
                Return Me._baseList
            End Get
        End Property
        ...
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Protected ReadOnly Property BaseTable() As System.Collections.Generic.Dictionary(Of String, car1.CarGroup)
            Get
        ...
        Public Overloads Default Property Item(ByVal index As Integer) As car1.CarGroup Implements System.Collections.Generic.IList(Of car1.CarGroup).Item
            Get
                Return CType(Me.BaseList(index),car1.CarGroup)
            End Get
            Set
        ...
        Property System_Collections_IList_Item(ByVal index As Integer) As Object Implements System.Collections.IList.Item
            ...
            End Get
            Set
                Me.BaseList(index) = CType(value,car1.CarGroup)
            End Set
        End Property
        
        Public Overloads Default Property Item(ByVal name As String) As car1.CarGroup
            Get
                If (name Is CType(Nothing, String)) Then
                    Throw New System.ArgumentNullException("name")
                End If
                Dim i As car1.CarGroup = Me.TryGetValue(name)
                Return i
            End Get
            Set
                If (name Is CType(Nothing, String)) Then
                ...
                If (value Is Nothing) Then
                    Dim carGroup As car1.CarGroup = Me.TryGetValue(name)
                    If (Not (carGroup) Is Nothing) Then
                        Me.Remove(carGroup)
                    End If
                    Return
                End If
                Dim existing As car1.CarGroup = Me.TryGetValue(value.Name)
        ...
        Public Overridable ReadOnly Property Count() As Integer Implements System.Collections.Generic.ICollection(Of car1.CarGroup).Count
            Get
        ...
        Public Overridable ReadOnly Property IsReadOnly() As Boolean Implements System.Collections.Generic.ICollection(Of car1.CarGroup).IsReadOnly
            Get
        ...
        Private ReadOnly Property SortDirection() As System.ComponentModel.ListSortDirection Implements System.ComponentModel.IBindingList.SortDirection
            Get
                Return Me._blm4043237448.SortDirection
            End Get
        End Property
        ...
        Private ReadOnly Property SortProperty() As System.ComponentModel.PropertyDescriptor Implements System.ComponentModel.IBindingList.SortProperty
            Get
                Return Me._blm4043237448.SortProperty
            End Get
        End Property
        ...
        Protected Overridable Sub Relate(ByVal item As car1.CarGroup, ByVal relationType As CodeFluent.Runtime.CodeFluentRelationType)
            CType(Me,CodeFluent.Runtime.ICodeFluentSet).Relations(item) = relationType
        End Sub
        
        Public Function Add(ByVal carGroup As car1.CarGroup) As Integer
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseAdd(carGroup)
            Return localAdd
        End Function
        
        Protected Overridable Function BaseAdd(ByVal carGroup As car1.CarGroup) As Integer
            ...
            End If
            Try 
                Me.BaseTable.Add(carGroup.Name, carGroup)
            Catch ane As System.ArgumentNullException
                Throw New System.ArgumentNullException(car1.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "car1.CarGroupCollection", carGroup.EntityKey), ane)
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(car1.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "car1.CarGroupCollection", carGroup.Name), ae)
            End Try
            AddHandler carGroup.KeyChanged, AddressOf Me.OnItemKeyChanged
            Dim localAdd As Integer = Me.BaseList.Count
            Me.BaseList.Add(carGroup)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, carGroup, localAdd))
        ...
        Function System_Collections_IList_Add(ByVal value As Object) As Integer Implements System.Collections.IList.Add
            ...
            If (carGroup Is Nothing) Then
                Throw New System.ArgumentException("value")
            End If
            Dim localAdd As Integer = Me.Add(carGroup)
            Return localAdd
        End Function
        
        <System.ComponentModel.BrowsableAttribute(false),  _
         System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)>  _
        Sub System_Collections_Generic_ICollection_car1_CarGroup__Add(ByVal carGroup As car1.CarGroup) Implements System.Collections.Generic.ICollection(Of car1.CarGroup).Add
            Me.BaseAdd(carGroup)
        End Sub
        
        Public Overridable Function AddByEntityKey(ByVal key As String) As car1.CarGroup
            Dim carGroup As car1.CarGroup = car1.CarGroup.LoadByEntityKey(key)
            If ((Not (carGroup) Is Nothing)  _
                        AndAlso (Me.Contains(carGroup) = false)) Then
                Me.Add(carGroup)
            End If
            Return carGroup
        End Function
        ...
        Public Overloads Overridable Sub Sort(ByVal comparer As System.Collections.Generic.IComparer(Of car1.CarGroup))
            Me.BaseList.Sort(comparer)
        End Sub
        
        Public Overloads Sub CopyTo(ByVal array() As car1.CarGroup, ByVal index As Integer) Implements System.Collections.Generic.ICollection(Of car1.CarGroup).CopyTo
            Me.BaseCopyTo(array, index)
        End Sub
        
        Protected Overridable Sub BaseCopyTo(ByVal array() As car1.CarGroup, ByVal index As Integer)
        ...
        Public Function Contains(ByVal carGroup As car1.CarGroup) As Boolean Implements System.Collections.Generic.ICollection(Of car1.CarGroup).Contains
            Dim localContains As Boolean = Me.BaseContains(carGroup)
            Return localContains
        End Function
        
        Protected Overridable Function BaseContains(ByVal carGroup As car1.CarGroup) As Boolean
            If (carGroup Is Nothing) Then
                Return false
            End If
            Dim localContains As Boolean = Me.BaseTable.ContainsKey(carGroup.Name)
            Return localContains
        End Function
        ...
        Function System_Collections_IList_Contains(ByVal value As Object) As Boolean Implements System.Collections.IList.Contains
            ...
            Catch icex As System.InvalidCastException
                carGroup = Nothing
            End Try
            Return Me.Contains(carGroup)
        End Function
        
        Public Function IndexOf(ByVal carGroup As car1.CarGroup) As Integer Implements System.Collections.Generic.IList(Of car1.CarGroup).IndexOf
            Dim localIndexOf As Integer = Me.BaseIndexOf(carGroup)
            Return localIndexOf
        End Function
        
        Protected Overridable Function BaseIndexOf(ByVal carGroup As car1.CarGroup) As Integer
            If (carGroup Is Nothing) Then
                Return -1
            End If
            Dim localIndexOf As Integer = Me.BaseList.IndexOf(carGroup)
            Return localIndexOf
        End Function
        ...
        Function System_Collections_IList_IndexOf(ByVal value As Object) As Integer Implements System.Collections.IList.IndexOf
            ...
            Catch icex As System.InvalidCastException
                carGroup = Nothing
            End Try
            Return Me.IndexOf(carGroup)
        End Function
        
        Public Overloads Sub Insert(ByVal index As Integer, ByVal carGroup As car1.CarGroup) Implements System.Collections.Generic.IList(Of car1.CarGroup).Insert
            Me.BaseInsert(index, carGroup)
        End Sub
        
        Protected Overridable Sub BaseInsert(ByVal index As Integer, ByVal carGroup As car1.CarGroup)
            If (carGroup Is Nothing) Then
                Throw New System.ArgumentNullException("carGroup")
            End If
            Try 
            ...
            Catch ae As System.ArgumentException
                Throw New System.ArgumentException(car1.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "car1.CarGroupCollection", carGroup.Name), ae)
            End Try
            Me.BaseList.Insert(index, carGroup)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, carGroup, index))
        ...
        Sub System_Collections_IList_Insert(ByVal index As Integer, ByVal value As Object) Implements System.Collections.IList.Insert
            ...
            Catch icex As System.InvalidCastException
                carGroup = Nothing
            End Try
            Me.Insert(index, carGroup)
        End Sub
        
        Public Overridable Sub Clear() Implements System.Collections.Generic.ICollection(Of car1.CarGroup).Clear
            Dim index As Integer
            Dim count As Integer = Me.Count
            index = 0
            Do While (index < count)
                Dim CarGroup As car1.CarGroup = Me(0)
                Me.BaseRemove(CarGroup)
                index = (index + 1)
            Loop
        ...
        Public Function Remove(ByVal carGroup As car1.CarGroup) As Boolean Implements System.Collections.Generic.ICollection(Of car1.CarGroup).Remove
            Return Me.BaseRemove(carGroup)
        End Function
        
        Protected Overridable Function BaseRemove(ByVal carGroup As car1.CarGroup) As Boolean
            If (carGroup Is Nothing) Then
                Throw New System.ArgumentNullException("carGroup")
            End If
            Dim index As Integer = Me.IndexOf(carGroup)
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of car1.CarGroup).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim ret As Boolean
            ret = Me.BaseList.Remove(carGroup)
            RemoveHandler carGroup.KeyChanged, AddressOf Me.OnItemKeyChanged
            ret = Me.BaseTable.Remove(carGroup.Name)
            Me.OnCollectionChanged(New CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, carGroup, index))
        ...
        Public Overridable Sub RemoveAt(ByVal index As Integer) Implements System.Collections.Generic.IList(Of car1.CarGroup).RemoveAt
            Me.OnListChanged(New System.ComponentModel.ListChangedEventArgs(CType(CodeFluent.Runtime.Utilities.SortableBindingList(Of car1.CarGroup).ListChangedTypeDeleting,System.ComponentModel.ListChangedType), index))
            Dim carGroup As car1.CarGroup = Me.BaseList(index)
            If (Not (carGroup) Is Nothing) Then
                RemoveHandler carGroup.KeyChanged, AddressOf Me.OnItemKeyChanged
                Me.BaseTable.Remove(carGroup.Name)
            End If
        ...
        Public Overridable Function GetEnumerator() As System.Collections.Generic.IEnumerator(Of car1.CarGroup) Implements System.Collections.Generic.IEnumerable(Of car1.CarGroup).GetEnumerator
            Dim e As System.Collections.Generic.IEnumerator(Of car1.CarGroup) = Me.BaseList.GetEnumerator
            Return e
        End Function
        ...
        Private Function TryGetValue(ByVal key As String) As car1.CarGroup
            Dim carGroup As car1.CarGroup = Nothing
            If (Me.BaseTable.TryGetValue(key, carGroup) = true) Then
                Return carGroup
            End If
            Return Nothing
        End Function
        ...
        Public Overridable Sub SaveAll()
            ...
            index = (Me.Count - 1)
            Do While (index >= 0)
                Dim carGroup As car1.CarGroup = Me(index)
                carGroup.Save
                If (carGroup.EntityState = CodeFluent.Runtime.CodeFluentEntityState.Deleted) Then
                    Me.Remove(carGroup)
                End If
                index = (index - 1)
            Loop
        ...
        Private Overloads Sub LoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions, ByVal reader As System.Data.IDataReader)
            ...
            Do While ((readerRead = true)  _
                ...
                If (CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) = true) Then
                    ...
                    CType(carGroup,CodeFluent.Runtime.ICodeFluentEntity).ReadRecord(reader)
                    If (Me.BaseContains(carGroup) = false) Then
                        Me.BaseAdd(carGroup)
                        count = (count + 1)
                    End If
        ...
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer, ByVal pageOptions As CodeFluent.Runtime.PageOptions) As car1.CarGroupCollection
            If (pageIndex < 0) Then
                pageIndex = 0
            End If
            If (pageSize < 0) Then
                ...
                End If
            End If
            Dim ret As car1.CarGroupCollection = New car1.CarGroupCollection()
            Dim reader As System.Data.IDataReader = Nothing
            Try 
                reader = car1.CarGroupCollection.PageDataLoadAll(pageOptions)
                If (reader Is Nothing) Then
                    Return ret
                End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function LoadAll() As car1.CarGroupCollection
            Dim ret As car1.CarGroupCollection = car1.CarGroupCollection.PageLoadAll(Integer.MinValue, Integer.MaxValue, Nothing)
            Return ret
        End Function
        ...
        Public Shared Function PageDataLoadAll(ByVal pageOptions As CodeFluent.Runtime.PageOptions) As System.Data.IDataReader
            ...
            persistence.CreateStoredProcedureCommand(Nothing, "CarGroup", "LoadAll")
            If (Not (pageOptions) Is Nothing) Then
        ...
        Public Shared Function DataLoadAll() As System.Data.IDataReader
            Dim reader As System.Data.IDataReader = car1.CarGroupCollection.PageDataLoadAll(Nothing)
            Return reader
        End Function
        ...
        Public Overloads Overridable Sub CopyTo(ByVal collection As car1.CarGroupCollection, ByVal deep As Boolean)
            If (GetType(System.ICloneable).IsAssignableFrom(GetType(car1.CarGroup)) = false) Then
                deep = false
            End If
            Dim enumerator As System.Collections.Generic.IEnumerator(Of car1.CarGroup) = Me.GetEnumerator
            Dim b As Boolean
            b = enumerator.MoveNext
            Do While b
                If (deep = true) Then
                    collection.Add(CType(CType(enumerator.Current,System.ICloneable).Clone,car1.CarGroup))
                Else
        ...
        Public Overridable Function Clone(ByVal deep As Boolean) As car1.CarGroupCollection
            Dim ret As car1.CarGroupCollection = New car1.CarGroupCollection()
            Me.CopyTo(ret, deep)
            Return ret
        End Function
        ...
        Private Sub AddIndex(ByVal [property] As System.ComponentModel.PropertyDescriptor) Implements System.ComponentModel.IBindingList.AddIndex
            Me._blm4043237448.AddIndex([property])
        End Sub
        ...
        Private Sub ApplySort(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal direction As System.ComponentModel.ListSortDirection) Implements System.ComponentModel.IBindingList.ApplySort
            Me._blm4043237448.ApplySort([property], direction)
        End Sub
        ...
        Private Function Find(ByVal [property] As System.ComponentModel.PropertyDescriptor, ByVal key As Object) As Integer Implements System.ComponentModel.IBindingList.Find
            Return Me._blm4043237448.Find([property], key)
        End Function
        ...
        Public Sub AddRange(ByVal collection As System.Collections.Generic.IEnumerable(Of car1.CarGroup))
        ...
        Private Sub OnItemKeyChanged(ByVal sender As Object, ByVal e As CodeFluent.Runtime.Utilities.KeyChangedEventArgs(Of String))
            ...
            If (e.OldKey Is Nothing) Then
                Return
            End If
            Dim existing As car1.CarGroup = Nothing
            ...
            If ((Not (sender) Is Nothing)  _
                ...
                Catch ane As System.ArgumentNullException
                    Throw New System.ArgumentNullException(car1.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.VoidCollectionKey, "car1.CarGroupCollection", CType(item,CodeFluent.Runtime.ICodeFluentEntity).EntityKey), ane)
                Catch ae As System.ArgumentException
                    Throw New System.ArgumentException(car1.Resources.Manager.GetUserMessage(Nothing, CodeFluent.Runtime.UserExceptionType.ItemAlreadyAdded, "car1.CarGroupCollection", item.Key), ae)
                End Try
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Shared Function PageLoadAll(ByVal pageIndex As Integer, ByVal pageSize As Integer) As car1.CarGroupCollection
            Return car1.CarGroupCollection.PageLoadAll(pageIndex, pageSize, Nothing)
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Shared Function Save(ByVal carGroup As car1.CarGroup) As Boolean
            If (carGroup Is Nothing) Then
                Return false
            End If
        ...
        Public Overloads Shared Function Insert(ByVal carGroup As car1.CarGroup) As Boolean
            Dim ret As Boolean = car1.CarGroup.Save(carGroup)
            Return ret
        End Function
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Shared Function Delete(ByVal carGroup As car1.CarGroup) As Boolean
            If (carGroup Is Nothing) Then
                Return false
            End If
